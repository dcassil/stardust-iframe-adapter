...
import {
  DEFAULT_MIN_DROP_HEIGHT,
  positionStyle,
  useDropArea,
} from "./overlays.internals.js";
import { InsertionZones } from "./overlays.zones.js";
...
export function TargetAreaOverlay({
  ...
  const drop = useDropArea(target, callbacks, dragActive);
  ...
  return (
    <div
      ...
      {...(drop.dragOver ? { "data-dragover": "" } : {})}
      onDragEnter={drop.handleAreaDragEnter}
      onDragLeave={drop.handleAreaDragLeave}
      onDragOver={drop.handleAreaDragOver}
      onDrop={drop.handleAreaDrop}
